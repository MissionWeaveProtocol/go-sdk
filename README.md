...
- byte-exact embedded protocol pin, 21 Draft 2020-12 schemas, and 56 conformance vectors;
...
- a 56-vector conformance runner and `missionweaveprotocol-conformance` command;
...
Success reports `56/56 conformance vectors passed`. The command exits non-zero for a validity
