...
- byte-exakter embedded protocol pin, 21 Draft-2020-12-schemas und 56 conformance vectors;
...
- 56-vector conformance runner und der Befehl `missionweaveprotocol-conformance`;
...
`KeyRegistryOrganizationWide`-Vollständigkeit zurückgeben; partielle Agent-Registry-Snapshots oder
...
Bei Erfolg wird `56/56 conformance vectors passed` ausgegeben. Der Befehl endet bei validity
